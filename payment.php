...
<title>IIARD | Make Payment - International Institute of Academic Research and development | Special Offers </title>
<!-- for-mobile-apps -->
...
<div class="col-md-6 single-top-left simpleCart_shelfItem wow fadeInRight animated" data-wow-delay=".5s">            
			...
			<div class="row wow fadeInDown animated" data-wow-delay=".5s">
			  <form role="form" method="post" action="" enctype="multipart/form-data" name="submit" id="submit">
					  ...
					  <p> <h4>1.   THROUGH BANK WIRE TRANSFER:</h4></p>
                ...
                <p style="text-align:justify">Kindly contact the editorial office to get receiver&rsquo;s payment details.     Please Note: After successful payment, send a copy of the bank teller, receipt or payment code to editor@iiardpub.org for payment Confirmation. </p>
                        ...
                        <hr class="bs-docs-separator wow fadeInDown animated" data-wow-delay=".5s">
                <h4>REFUND POLICY</h4>
                <p style="text-align:justify">If payment was mistakenly paid twice, we shall refund you through bank transfer.  Bank charges shall be made by the author. Please discuss this issue to <code>editor@iiardpub.org</code>.<br>
                        However, we will not make any refund if an article has already been publish online. </p>
                <p>&nbsp;</p>
        ...
        <div class="col-md-6 wow fadeInLeft animated" data-wow-delay=".5s">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<td><h1>Secure Online Payment</h1>
...
<form action="https://secure.payza.com/checkout" method="post" name="form1" target="_blank"> 
	...
	<input name="ap_cancelurl" type="hidden" value="http://www.payza.com/Cancel.html" />        
	<input name="ap_returnurl" type="hidden" value="http://www.payza.com/Policies.html" />        
